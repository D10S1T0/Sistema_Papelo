<?php
    ...
    if (!isset($_SESSION['usuario']) || $_SESSION['tipo'] !== 'empleado' || strtolower($_SESSION['puesto']) !== 'cajero') {
        header("Location: ../html/Login.php");
        exit();
    }

    //isset revisa si se paso seccion por get  si no pongo por defecto articulos  
    $seccionesPermitidas = ['articulos', 'cobro', 'compras'];
...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" href="..\Estilos\dashAdmi.css?v=1.1">
        
    </head>
    <body>  
        <!--Menu lateral -->
        <?php include '..\Includes\menuLateralCajero.php';?>
                ...
                <div class="d-flex align-items-center">
                   <h3>
                        <div class="user-profile d-flex align-items-center ">
                            ...
                            <span> Cajero: <?php echo $_SESSION['usuario'] ?></span>
                        </div>
                    </h3> 
                </div>
            </div>
